    ...
    if csv==True:
        ...
        for i in range(0,len(sat_names)-falcons,seperations):
            for j in range(i+1,len(sat_names)-falcons,seperations):
                ...
                d = distance_functions.distance4RaDec(sat_lat[i], sat_lat[j], sat_lon[i], sat_lon[j])
...
def main():
    TestFileCreate( "distances_5_1_nodes","distances_5_1_names","distances_5_1",numOfSat=150 ,m=0,md=15000)
    #testGraphIst("distances_5_1_nodes_vg_graphs")
    #TestFileCreate( "distances_10_15_nodes","distances_10_15_names","distances_10_15",numOfSat=450 ,m=1)
    #testGraphIst("distances_10_15_nodes_vgr_graphs")


    #createFilesFromTLe(5,1 ,lat_lon__csv_file=True,distance_csv_file=True,VG_files=True)
